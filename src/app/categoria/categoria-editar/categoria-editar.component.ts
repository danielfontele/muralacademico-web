...
export class CategoriaEditarComponent implements OnInit {
  ...
  selectedRow(row: CategoriaDto) {
    ...
    this.formCategoria.controls['versao'].setValue(row.versao + 1);
  }
  ...
  onSubmit(): void {
    ...
    this.categoriaService.edit(this.categoria).subscribe(() => {
      this.categoriaService.showMessage('Cliente editado com sucesso', false);
    });
  }
