...
@Component({
  selector: 'app-postagem-deletar',
  templateUrl: './postagem-deletar.component.html',
  styleUrls: ['./postagem-deletar.component.css'],
  providers: [
...
export class PostagemDeletarComponent implements OnInit {
  ...
  ngOnInit(): void {
    ...
    this.formPostagem.controls['conteudo'].disable();
    this.formPostagem.controls['data'].disable();
    this.formPostagem.controls['nivel'].disable();
  ...
  selectedRow(row: PostagemDto) {
    ...
    this.formPostagem.controls['versao'].setValue(row.versao);
  }
  ...
  onSubmit(): void {
    ...
    this.postagemService.delete(this.postagem.id);
    this.postagemService.list().subscribe(dados => {
      this.postagems = dados;
      this.dataSource = this.postagems;
    });
